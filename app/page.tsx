...
export default function Home() {
  return (
    ...
    <section className="relative w-screen h-screen md:h-[calc(100vh-60px)] flex items-center justify-center">
      ...
      <span className="text-white font-semibold text-4xl md:text-7xl">Retail </span>
      <span className="text-yellow-400 font-semibold text-4xl md:text-7xl ">Compliance</span>
      ...
      className="mb-24"
      >
      <span className="text-white font-semibold text-4xl md:text-7xl">Starts  </span>
      <span className="text-white font-semibold text-4xl md:text-7xl  ">here</span>
    ...
    <AnimatedDiv>
       ...
       <div className="relative mb-48 p-6 md:p-24 w-11/12 h-auto flex flex-col items-center justify-start">
       ...
       <div className="">
        ...
        <div className="flex flex-col mb-30 w-screen px-6 md:px-24 md:flex-row items-center gap-4 justify-between">
        <AnimatedDiv>
        <div className="max-w-72 max-h-120 bg-[rgb(245,244,253,.7)] backdrop-blur-lg  rounded-lg overflow-hidden hover:scale-105">
