...
<div className="w-11/12 mt-24 m-6 md:mt-0  md:w-2/4 self-center flex flex-col items-center justify-center  ">
    <div className="text-3xl md:text-6xl  justify-center">Announcing RetailReady’s 
</div>
<div className=" text-3xl md:text-6xl justify-center mb-12">$3.3M Seed Fundraising
</div>
<iframe className="w-[500px] md:w-[600px]"  height="355"  src="https://www.youtube.com/embed/YZ4n45Ao_FQ?si=czCoguSeiuilIwtM" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen="true"></iframe>
